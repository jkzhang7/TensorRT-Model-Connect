...
// GlmAsrInferenceState: unified interface for autoregressive inference state.
//
// The decoder KV-cache implementation exposes this interface. Pipelines and
...
//
// Implementation:
//   GlmAsrKvCache — dense append-only decoder state
...
class GlmAsrInferenceState {
  public:
    virtual ~GlmAsrInferenceState() = default;
